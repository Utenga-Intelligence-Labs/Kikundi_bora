...
type WelfareEvent struct {
	...
	AmountRequested float64              `gorm:"type:decimal(15,2);not null" json:"amount_requested"`
	AmountApproved  *float64             `gorm:"type:decimal(15,2)" json:"amount_approved,omitempty"`
	FundingSource   WelfareFundingSource `gorm:"type:varchar(30);not null" json:"funding_source"`
	TreasuryAmount  float64              `gorm:"type:decimal(15,2);not null;default:0" json:"treasury_amount"`
	MemberAmount    float64              `gorm:"type:decimal(15,2);not null;default:0" json:"member_amount"`
